...
{
    internal class PowerArmor : UIState
    {
        public override void OnInitialize()
        {
            ...
            barFrame = new UIImage(ModContent.GetTexture("SummonHeart/ui/Bar/PowerArmorFrame"));
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            {
                PowerArmorBase powerArmorBase = mp.powerArmor.GetGlobalItem<PowerArmorBase>();
                text.SetText($"护盾值：{powerArmorBase.powerArmorCount} / {powerArmorBase.powerArmorMax}");
            }
            else
            {
                return;
