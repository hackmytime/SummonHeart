                        ...
                        case 1:
                            {
                                ...
                                if (HasWeapon)
                                {
                                    ...
                                    if (ShootCD == 0 && player.whoAmI == Main.myPlayer)
                                    {
                                        ...
                                        Projectile.NewProjectileDirect(npc.Center - vel * 60f, vel, ModContent.ProjectileType<DragonLegacyBlue>(), player.SummonHeart().flySwordBlood, 6.6f, player.whoAmI, 0f, 0f).netUpdate = true;
