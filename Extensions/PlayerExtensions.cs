...
namespace SummonHeart.Extensions
{
    ...
    public static class PlayerExtensions
    {
		...
		public static void doKillNpcExp(this Player player, NPC npc)
        {
            ...
            int qiyun = mp.GetStat(XiuXianModule.EnumType.Stat.气运);
			int tier = level % 10;
			if (tier == 0)
            {
				tier = 10;
			...
			if (level <= 10)
            {
				if (Main.rand.Next(1000 - 50*tier) <= qiyun)
				{
					player.QuickSpawnItem(ModContent.ItemType<LingShi1>(), Mathf.CeilInt(qiyun / 100));
				}
				if (Main.rand.Next(10000 - 500*tier) <= qiyun)
				{
					player.QuickSpawnItem(ModContent.ItemType<NeiDan1>(), Mathf.CeilInt(qiyun / 100));
				}
			}
			else if(level <= 20)
            {
				if (Main.rand.Next(1000 - 90 * tier) <= qiyun)
				{
					player.QuickSpawnItem(ModContent.ItemType<LingShi1>(), Mathf.CeilInt(qiyun / 100) * tier);
				}
				if (Main.rand.Next(10000 - 900 * tier) <= qiyun)
				{
					player.QuickSpawnItem(ModContent.ItemType<NeiDan2>(), Mathf.CeilInt(qiyun / 100));
				}
			}
			else if (level <= 30)
			{
				if (Main.rand.Next(1000 - 100 * tier) <= qiyun)
				{
					player.QuickSpawnItem(ModContent.ItemType<LingShi2>(), Mathf.CeilInt(qiyun / 100));
				}
				if (Main.rand.Next(10000 - 900 * tier) <= qiyun)
				{
					player.QuickSpawnItem(ModContent.ItemType<NeiDan3>(), Mathf.CeilInt(qiyun / 100));
				}
			}
			else if (level <= 40)
			{
				if (Main.rand.Next(1000 - 90 * tier) <= qiyun)
				{
					player.QuickSpawnItem(ModContent.ItemType<LingShi2>(), Mathf.CeilInt(qiyun / 100) * tier);
				}
				if (Main.rand.Next(10000 - 900 * tier) <= qiyun)
				{
					player.QuickSpawnItem(ModContent.ItemType<NeiDan4>(), Mathf.CeilInt(qiyun / 100));
				}
			}
			else if (level <= 50)
			{
				if (Main.rand.Next(1000 - 90 * tier) <= qiyun)
				{
					player.QuickSpawnItem(ModContent.ItemType<LingShi3>(), Mathf.CeilInt(qiyun / 100));
				}
				if (Main.rand.Next(10000 - 900 * tier) <= qiyun)
				{
					player.QuickSpawnItem(ModContent.ItemType<NeiDan5>(), Mathf.CeilInt(qiyun / 100));
				}
			}
			else if (level <= 60)
			{
				if (Main.rand.Next(1000 - 90 * tier) <= qiyun)
				{
					player.QuickSpawnItem(ModContent.ItemType<LingShi3>(), Mathf.CeilInt(qiyun / 100) * tier);
				}
				if (Main.rand.Next(10000 - 900 * tier) <= qiyun)
				{
					player.QuickSpawnItem(ModContent.ItemType<NeiDan6>(), Mathf.CeilInt(qiyun / 100));
				}
			}
			else if (level <= 70)
			{
				if (Main.rand.Next(1000 - 90 * tier) <= qiyun)
				{
					player.QuickSpawnItem(ModContent.ItemType<LingShi4>(), Mathf.CeilInt(qiyun / 100));
				}
				if (Main.rand.Next(10000 - 900 * tier) <= qiyun)
				{
					player.QuickSpawnItem(ModContent.ItemType<NeiDan7>(), Mathf.CeilInt(qiyun / 100));
				}
			}
			else if (level <= 80)
			{
				if (Main.rand.Next(1000 - 90 * tier) <= qiyun)
				{
					player.QuickSpawnItem(ModContent.ItemType<LingShi4>(), Mathf.CeilInt(qiyun / 100) * tier);
				}
				if (Main.rand.Next(10000 - 900 * tier) <= qiyun)
				{
					player.QuickSpawnItem(ModContent.ItemType<NeiDan8>(), Mathf.CeilInt(qiyun / 100));
				}
			}
