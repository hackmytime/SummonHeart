    ...
    public class MagicScroll : ModItem
    {
        ...
        public override bool UseItem(Player player)
        {
            ...
            if (modPlayer.PlayerClass == 0 || modPlayer.PlayerClass == 5)
            {
                ...
                {
                    Main.NewText("已领悟法师传承，请按L查看详情", 255, 255, 255);
                }
