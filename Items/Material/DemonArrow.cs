...
using SummonHeart.Items.Range.Ammo;
...
namespace SummonHeart.Items.Material
{
    public class DemonArrow : ModItem
    {
        ...
        {
            DisplayName.SetDefault("DemonArrow");
            Tooltip.SetDefault("DemonArrow");
            DisplayName.AddTranslation(GameCulture.Chinese, "魔神的灵魂碎片·箭矢兑换");
            Tooltip.AddTranslation(GameCulture.Chinese, "左键献祭十万灵魂之力获得9999发追踪穿透箭矢" +
                "\n右键献祭百万灵魂之力获得999发风暴狙击箭");
        }
        ...
        public override bool UseItem(Player player)
        {
            ...
            if (player.altFunctionUse == 2)
            {
                ...
                else
                {
                    ...
                    mp.BBP -= 1000000;
                    player.QuickSpawnItem(ModContent.ItemType<TornadoArrow>(), 999);
                }
            }
            else
            {
                ...
                else
                {
                    ...
                    mp.BBP -= 100000;
                    player.QuickSpawnItem(ModContent.ItemType<TracingArrow>(), 9999);
                }
            }
            return true;
        }
