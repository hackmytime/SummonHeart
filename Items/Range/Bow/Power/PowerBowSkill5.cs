...
{
    public class PowerBowSkill5 : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("PowerBowSkill5");
            Tooltip.SetDefault("PowerBowSkill5");
            DisplayName.AddTranslation(GameCulture.Chinese, "核心科技·弓弩强化Lv5");
            Tooltip.AddTranslation(GameCulture.Chinese, "炼化压缩融合8把，蓄力上限900，蓄力速度，1帧5层" +
                "\n每1层蓄力伤害提升0.2倍，暴击几率+1%，每1层蓄力消耗5点能量" +
                "\n前8号物品栏放满同类型的弓弩，左键使用消耗能量核心Lv5进行炼化压缩融合");
        }
        ...
        public override bool UseItem(Player player)
        {
            ...
            if (player.altFunctionUse == 2)
            {
                //处理升级
                item.TurnToAir();
                mp.player.QuickSpawnItem(ModContent.ItemType<PowerBowSkill6>(), 1);
