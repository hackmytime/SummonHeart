...
{
    public class MultiBowSkill5 : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            Tooltip.AddTranslation(GameCulture.Chinese, "前6号物品栏放置6把同类型的弓，左键使用消耗1个能量核心Lv5组合6把弓");
        }
        ...
        public override bool UseItem(Player player)
        {
            ...
            else
            {
                ...
                {
                    CombatText.NewText(player.getRect(), Color.Red, "1、2、3、4、5、6号物品栏武器类型不同，无法合成");
                }
                else
                {
                    ...
                    {
                        CombatText.NewText(player.getRect(), Color.Red, "1、2、3、4、5、6号物品栏武器类型不是弓弩，无法合成");
                    }
                }
            }
