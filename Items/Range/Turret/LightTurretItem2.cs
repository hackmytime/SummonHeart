...
{
    public class LightTurretItem2 : TurretItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("4级科技造物·初级闪电炮塔");
        ...
        public override void AddRecipes()
        {
            ...
            modRecipe.AddIngredient(ModContent.ItemType<LightGenerator1>(), 5);
            modRecipe.AddIngredient(ModContent.ItemType<CoreComputer>(), 1);
            modRecipe.AddIngredient(ModContent.ItemType<Power2>(), 10);
            modRecipe.AddIngredient(ModContent.ItemType<PowerArmor2>(), 1);
