...
{
    public class PowerArmorSkill2 : ModItem
    {

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("PowerArmorSkill2");
            Tooltip.SetDefault("PowerArmorSkill2");
            DisplayName.AddTranslation(GameCulture.Chinese, "核心科技·能量护甲制造Lv2");
            Tooltip.AddTranslation(GameCulture.Chinese, "通过炼金术将金属元件和能量核心炼化成能量护甲" +
                "\n左键使用炼金术消耗200金属元件和10个能量核心Lv2进行制造");
        }
        ...
        public override bool UseItem(Player player)
        {
            ...
            ItemCost[] costArr = new ItemCost[] {
                new ItemCost(ModContent.ItemType<MetalUnit>(), 200),
                new ItemCost(ModContent.ItemType<Power2>(), 10)
            };
            ...
            else
            {
                ...
                else if (Builder.CanPayCost(costArr, player))
                {
                    ...
                    mp.player.QuickSpawnItem(ModContent.ItemType<PowerArmor2>(), 1);
