...
{
    public class PowerArmorSkill6 : ModItem
    {

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("PowerArmorSkill6");
            Tooltip.SetDefault("PowerArmorSkill6");
            DisplayName.AddTranslation(GameCulture.Chinese, "核心科技·能量护甲制造Lv6");
            Tooltip.AddTranslation(GameCulture.Chinese, "通过炼金术将金属元件和能量核心炼化成能量护甲" +
                "\n左键使用炼金术消耗600金属元件和10个能量核心Lv6进行制造");
        }
        ...
        public override bool UseItem(Player player)
        {
            ...
            ItemCost[] costArr = new ItemCost[] {
                new ItemCost(ModContent.ItemType<MetalUnit>(), 600),
                new ItemCost(ModContent.ItemType<Power6>(), 10)
            };
            ...
            else
            {
                ...
                else if (Builder.CanPayCost(costArr, player))
                {
                    ...
                    mp.player.QuickSpawnItem(ModContent.ItemType<PowerArmor6>(), 1);
