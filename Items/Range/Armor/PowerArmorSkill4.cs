...
{
    public class PowerArmorSkill4 : ModItem
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            DisplayName.AddTranslation(GameCulture.Chinese, "核心科技·能量护甲制造Lv4");
            Tooltip.AddTranslation(GameCulture.Chinese, "通过炼金术将金属元件和能量核心炼化成能量护甲" +
                "\n左键使用炼金术消耗400金属元件和10个能量核心Lv4进行制造");
        }
        ...
        public override bool UseItem(Player player)
        {
            ...
            ItemCost[] costArr = new ItemCost[] {
                new ItemCost(ModContent.ItemType<MetalUnit>(), 400),
                new ItemCost(ModContent.ItemType<Power4>(), 10)
            };
            if (player.altFunctionUse == 2)
            {
                //处理升级
                mp.player.QuickSpawnItem(ModContent.ItemType<PowerArmorSkill5>(), 1);
            ...
            else
            {
                ...
                else if (Builder.CanPayCost(costArr, player))
                {
                    ...
                    mp.player.QuickSpawnItem(ModContent.ItemType<PowerArmor4>(), 1);
