...
{
    public class Fertilizer2 : ModItem
    {
        ...
        {
            DisplayName.SetDefault("Concentrated Fertilizer");
            Tooltip.SetDefault("");
            DisplayName.AddTranslation(GameCulture.Chinese, "2级科技造物·超级金坷垃");
        }

        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            tooltips.Add(new TooltipLine(mod, "点击树苗或植物，使其迅速生长", "点击树苗或植物，使其迅速生长")
            {
            ...
            tooltips.Add(new TooltipLine(mod, "而且可以用在沙子上，让仙人掌立刻生长。", "而且可以用在沙子上，让仙人掌立刻生长。")
            {
                overrideColor = new Color?(new Color(0, 150, 0))
            });
        ...
        public override void AddRecipes()
        {
            ...
            modRecipe.AddIngredient(null, "Fertilizer", 99);
            modRecipe.AddIngredient(mod.GetItem("Loot2"), 5);
        ...
        public override bool UseItem(Player player)
        {
            ...
            else
            {
                ...
                if (Math.Abs(Main.MouseWorld.X - player.position.X) < 100f && Math.Abs(Main.MouseWorld.Y - player.position.Y) < 70f && Main.tile[Player.tileTargetX, Player.tileTargetY].frameX != 90 && Main.tile[Player.tileTargetX, Player.tileTargetY].type == mod.TileType("CoballidiumPlant"))
                {
                    Main.PlaySound(6, -1, -1, 1, 1f, 0f);
                    ...
                    {
                        Main.tile[Player.tileTargetX, Player.tileTargetY].frameX = 90;
                        NetMessage.SendTileSquare(-1, Player.tileTargetX, Player.tileTargetY, 99, 0);
                    }
                    return true;
                }
                if (Math.Abs(Main.MouseWorld.X - player.position.X) < 100f && Math.Abs(Main.MouseWorld.Y - player.position.Y) < 70f && Main.tile[Player.tileTargetX, Player.tileTargetY].frameX != 90 && Main.tile[Player.tileTargetX, Player.tileTargetY].type == mod.TileType("MythalcumPlant"))
                {
                    Main.PlaySound(6, -1, -1, 1, 1f, 0f);
                    int num5 = Dust.NewDust(new Vector2(Main.MouseWorld.X, Main.MouseWorld.Y), 16, 16, mod.DustType("FertDust"), 0f, 0f, 0, default, 1f);
                    Main.dust[num5].scale = 3f;
                    Main.dust[num5].position = Main.MouseWorld - Main.dust[num5].scale * new Vector2(4f, 4f);
                    if (Main.rand.Next(0, 2) == 0)
                    {
                        Main.tile[Player.tileTargetX, Player.tileTargetY].frameX = 90;
                        NetMessage.SendTileSquare(-1, Player.tileTargetX, Player.tileTargetY, 99, 0);
                ...
                if (Math.Abs(Main.MouseWorld.X - player.position.X) < 100f && Math.Abs(Main.MouseWorld.Y - player.position.Y) < 70f && Main.tile[Player.tileTargetX, Player.tileTargetY].frameX != 90 && Main.tile[Player.tileTargetX, Player.tileTargetY].type == mod.TileType("AdantiumPlant"))
                {
                    Main.PlaySound(6, -1, -1, 1, 1f, 0f);
                ...
                if (Math.Abs(Main.MouseWorld.X - player.position.X) < 100f && Math.Abs(Main.MouseWorld.Y - player.position.Y) < 70f && Main.tile[Player.tileTargetX, Player.tileTargetY].frameX != 90 && Main.tile[Player.tileTargetX, Player.tileTargetY].type == mod.TileType("ChlorophytePlant"))
                {
                    Main.PlaySound(6, -1, -1, 1, 1f, 0f);
                ...
                {
                    Main.PlaySound(6, -1, -1, 1, 1f, 0f);
                    int num10 = Dust.NewDust(new Vector2(Main.MouseWorld.X, Main.MouseWorld.Y), 16, 16, mod.DustType("FertDust"), 0f, 0f, 0, default, 1f);
                    Main.dust[num10].scale = 3f;
                    Main.dust[num10].position = Main.MouseWorld - Main.dust[num10].scale * new Vector2(4f, 4f);
                ...
                {
                    Main.PlaySound(6, -1, -1, 1, 1f, 0f);
                    int num11 = Dust.NewDust(new Vector2(Main.MouseWorld.X, Main.MouseWorld.Y), 16, 16, mod.DustType("FertDust"), 0f, 0f, 0, default, 1f);
                    Main.dust[num11].scale = 3f;
                    Main.dust[num11].position = Main.MouseWorld - Main.dust[num11].scale * new Vector2(4f, 4f);
                    if (Main.rand.Next(0, 1) == 0)
                    {
                ...
                {
                    Main.PlaySound(6, -1, -1, 1, 1f, 0f);
                    int num12 = Dust.NewDust(new Vector2(Main.MouseWorld.X, Main.MouseWorld.Y), 16, 16, mod.DustType("FertDust"), 0f, 0f, 0, default, 1f);
                    Main.dust[num12].scale = 3f;
                    Main.dust[num12].position = Main.MouseWorld - Main.dust[num12].scale * new Vector2(4f, 4f);
                    int num13 = Main.rand.Next(0, 9);
                    if (num13 < 7)
                    {
